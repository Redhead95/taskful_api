...
class HouseViewSet(viewsets.ModelViewSet):
    ...
    def join(self, request, pk=None):
        try:
            ...
            if user_profile.house == None:
                ...
                return Response({'message': 'Already a member in this house.'}, status=status.HTTP_400_BAD_REQUEST)
            else:
                return Response({'message': 'Already a member in another house.'}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def leave(self, request, pk=None):
        try:
            ...
            if user_profile in house.members.all():
                ...
                return Response({'message': 'User not a member in this house.'}, status=status.HTTP_400_BAD_REQUEST)
        except Exception as e:
            return Response(status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    ...
    def remove_member(self, request, pk=None):
        try:
            ...
            return Response({'message': 'Provided user_id does not exist.'}, status=status.HTTP_400_BAD_REQUEST)
